...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="adminDashboard.jsp#overview"><i class="fas fa-tachometer-alt"></i> Overview</a>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= role %></td>
                    <td>
                        <a href="editUser.jsp?user_id=<%= user_id %>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="deleteUser.jsp?user_id=<%= user_id %>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                    </td>
                </tr>
                <% 
                        }
